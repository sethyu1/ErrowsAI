...
export function Cropper(props: CropperProps) {
  ...
  return (
    <div className="p-8">
      <div className="px-15 flex gap-3">
        ...
        <div className="flex flex-col flex-1">
          <div className="font-bold text-center text-sm text-[#A4ACB9]">
            {t('auth.previewPhoto')}
          </div>
          <div className="mt-11 w-40 h-40 mx-auto rounded-full overflow-hidden">
            <img src={base64} className="w-full h-full" />
          </div>
        </div>
      </div>
